...
const SUGGESTIONS = [
  "How many referrals were processed today?",
  "Show me all referrals from Dr. Holt",
  "What is the status of Margaret Kowalski's referral?",
  "Which insurance provider has the most referrals?",
];
    ...
    <div className="flex flex-col h-[calc(100vh-1rem)]">
      <div className="p-4 border-b border-border shrink-0">
        ...
        <Text level="xSmall" color="muted">
          Ask questions about referrals, patients, and automation status
        </Text>
      </div>
        ...
        {isLoadingMessages ? (
          ...
          <div className="flex flex-col items-center justify-center h-full gap-6">
            <div className="text-center">
              ...
              <Title level="h3">Ask about referrals</Title>
              <Text color="muted" className="mt-1">
                I can help you look up patient referrals, check processing
                status, and answer questions about the automation.
              </Text>
            </div>
